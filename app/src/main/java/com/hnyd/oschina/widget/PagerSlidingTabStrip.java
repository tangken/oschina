...
public class PagerSlidingTabStrip extends HorizontalScrollView implements View.OnClickListener {
    ...
    private float currentPositionOffset;//当前位置偏移
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        adjustChildWidthWithParent(tabViews, getMeasuredWidth() - tabsLayout.getPaddingLeft() -
                tabsLayout.getPaddingRight(), widthMeasureSpec, heightMeasureSpec);
        super.onMeasure(widthMeasureSpec, heightMeasureSpec);
    }

    private void adjustChildWidthWithParent(List<View> views, int parentViewWidth, int
            parentWidthMeasureSpec, int parentHeightMeasureSpec) {
        //先去掉所有子View的外边距
        for (View view : views) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (tabViewGroup != null) {
            ...
            if (!disableViewPager) {
                ...
                selectedTab(currentPosition);//选中的Tab
            }
...
//TODO
    ...
    private void selectedTab(int currentSelectedTabPosition) {
        ViewGroup tabsLayout = getTabsLayout();
        if (currentSelectedTabPosition > -1 && tabsLayout != null && currentSelectedTabPosition <
    ...
    public void setViewPager(ViewPager viewPager) {
        ...
        this.viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            @Override
            public void onPageScrolled(int nextPagePosition, float positionOffset, int
    ...
    private void scrollToChild(int postion, int offset) {
        ViewGroup tabsLayout = getTabsLayout();
        if (tabsLayout != null && tabsLayout.getChildCount() > 0 && postion < tabsLayout
                .getChildCount()) {
            View view = tabsLayout.getChildAt(postion);
            if (view != null) {
                //计算新的坐标
                int newScrollX = view.getLeft() + offset;
                if (postion > 0 || offset > 0) {
            ...
            if (currentTab != null) {
                ...
                if (currentPositionOffset > 0f
                    ...
                    if (nextTab != null) {
                        ...
                        slidingBlockLeft = (currentPositionOffset * nextTabLeft + (1f -
    ...
    public ViewGroup getTabsLayout() {
        if (tabsLayout == null) {
            if (getChildCount() > 0) {
                ...
                addView(tabsLayout, new ViewGroup.LayoutParams(ViewGroup.LayoutParams
